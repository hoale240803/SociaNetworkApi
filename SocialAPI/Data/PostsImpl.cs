...
namespace SocialAPI.Data
{
    public class PostsImpl : IPosts
    {
        ...
        public async Task<Post> GetPost(uint? postId)
        {
        ...
        public async Task<uint> AddPost(Post post)
        {
            if (db != null)
            {
        ...
        public async Task<uint> DeletePost(uint? postId)
        {
            uint result = 0;
            ...
            if (db != null)
            {
                ...
                if (post != null)
                {
                    ...
                    result = (uint)await db.SaveChangesAsync();
                }
                return result;
            }
        ...
        public async Task PatchPost(JsonPatchDocument<Post>  post, uint id)
        {
            if (db != null)
            {
