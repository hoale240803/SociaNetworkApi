...
namespace Social.Controllers
{
    ...
    public class PostsController : ControllerBase
    {
        ...
        [HttpPost]
        [Route("AddPost")]
        public async Task<IActionResult> AddPost([FromBody] Posts model)
        {
        ...
        [HttpPut]
        [Route("UpdatePost")]
        public async Task<IActionResult> UpdatePost([FromBody] Posts model)
        {
            if (ModelState.IsValid)
            {
                try
        ...
        [HttpPatch]
        [Route("EditPost")]
        public IActionResult JsonPatchWithModelState([FromBody] JsonPatchDocument<Posts> patchDoc)
        {
            if (patchDoc != null)
            {
                var post = new Posts();
        ...
        [HttpPatch("{id}")]
        public IActionResult EditPatialPost( [FromBody] JsonPatchDocument<Posts> post, int id)
        {
